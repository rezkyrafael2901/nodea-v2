...
async function main() {
  // Testnet (Moksha) builder registration
  const GATEWAY_URL = "https://dp-rpc.moksha.vana.org";
  const NETWORK = "moksha";
  ...
  console.log("Registered testnet app identity:", account.address);
